...
function myaction(){
		...
		document.form1.action="ready.php?status=ready";
...
<form name="form1" action="ready.php" method="Get">
<input type=hidden name=id value="<?php echo session_id();?>">
<input type=hidden name=status value="ready">
<label class="switch switch-green"><input id=switch1 type="checkbox" class="switch-input" onchange="myaction();"><span class="switch-label" data-on="ready" data-off="in progress"></span><span class="switch-handle"></span></label>
<br><br>Bitte schalten sie auf grün, <br>wenn ihre Aufgabe erledigt ist.
</form>
